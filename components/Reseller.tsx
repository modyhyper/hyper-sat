...
import { TrendingUp, DollarSign, MessageCircle, Sparkles, Star } from "lucide-react";
...
export default function Reseller() {
  ...
  return (
    <section id="reseller" className="py-32 relative overflow-hidden flex items-center justify-center min-h-screen">
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-400">Turn your network into net worth.</p>
        </motion.div>
